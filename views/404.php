...
<svg id="lightSVG" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 470">
    <filter id="white-glow">
        <feFlood result="flood" flood-color="#fffffff0" flood-opacity=".6"></feFlood>
    ...
    <g id="light" style="visibility: hidden;">
        <path filter="url(#white-glow)" fill="#F1F1E1" d="M122.2 177.4c-5.2-1.6-13.6 2.1-20.6 8.3-7.7 6.8-11.4 16.8-9.3 22.1L421 1683h1534V733L122.2 177.4z" />
...
<div class="content">
    ...
    <p>
        ...
        <?php if ($nearestPage !== null) : ?>
            <a class="link" href="<?= $router->generateUri($nearestPage['path']) ?>">Vous vouliez <?= htmlentities($nearestPage['title']) ?> ?</a>
        <?php endif; ?>
    </p>
</div>
